    ...
    <div className="body">
      <div className="container-dash">
        ...
        <div className="flex gap-2 mb-4">
          ...
          />
          <Button text="Adicionar Cliente" onClick={handleAdd} />
        </div>
        ...
        <div className="tbe w-full max-w-3xl mt-8 rounded-2xl overflow-hidden shadow-lg">
          <div className="tablee grid grid-cols-5 gap-x-6 items-center p-4 bg-blue-100 border-b font-medium text-blue-900">
            <p className="id-center">ID</p>
            <p>Nome</p>
            <p>Email</p>
            <p>Telefone</p>
            <p className="text-centere">Ações</p>
          </div>
        ...
        >
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center w-full gap-4">
              ...
              <Button text="Salvar Alterações" onClick={handleEdit} />
            </div>
          ) : (
            <div className="text-center">Erro ao carregar cliente</div>
          )}
        </Modal>
      </div>
    </div>
